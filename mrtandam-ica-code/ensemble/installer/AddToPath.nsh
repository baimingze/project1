...
Function DumpLog
  ...
  StrCpy $5 "$INSTDIR\installer.log"
...
!macro LogAbort txt
DetailPrint "${txt}"
MessageBox MB_OK "Installation did not complete : ${txt}.  Check installer.log for details."
Call DumpLog
Abort "${txt}"
!macroend

!macro LogExecWait cmd result
DetailPrint 'in $OUTDIR execute: ${cmd}'
nsExec::ExecToLog '${cmd}' 
pop ${result}
!macroend

; based on http://nsis.sourceforge.net/Check_for_spaces_in_a_directory_path
; but counts slash instead of space
